...
thing to do. In the [subsequent article](Auto_Part2.md) I will look at some of the forces involved in deciding when
to use (and when
...
<hr>
Copyright (c) Roger Orr 2021-07-06 (First published in Overload, Jun 2013.)

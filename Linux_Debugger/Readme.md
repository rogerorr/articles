...
`PTRACE_DENY_ATTACH` function code to prevent it from being debugged. This is one of the places where the age of the API
...
call to `ptrace` with argument `PTRACE_TRACEME` in the **child** process. In Unix the standard way to create a child process
